...
export class Migration20260322103416 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "users" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid null, "organization_id" uuid null, "email" text not null, "email_hash" text null, "name" text null, "password_hash" text null, "is_confirmed" boolean not null default true, "last_login_at" timestamptz null, "created_at" timestamptz not null, "deleted_at" timestamptz null, constraint "users_pkey" primary key ("id"));`);
