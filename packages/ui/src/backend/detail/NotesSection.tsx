...
import { AppearanceDialog } from '@open-mercato/core/modules/dictionaries/components/AppearanceDialog'
...
function NotesSectionImpl<C = unknown>({
  ...
  onActionChange,
  translator,
  labelPrefix = 'common.detail.notes',
  inlineLabelPrefix = 'common.detail.inline',
  onLoadingChange,
  dealOptions,
  entityOptions,
  dataAdapter,
