...
import OpenApiExplorerBanner from '@/components/OpenApiExplorerBanner';
...
- The array includes entries for every enabled module; modules without HTTP handlers contribute an empty list.
