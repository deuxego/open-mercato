...
| `--module <id>` | Filter by source module | `--module example` |
...
yarn mercato scheduler list --module example
```
...
├────────────────────────────────────┼─────────────────────┼──────────┼──────────┼────────────┼────────────┼─────────┼────────┤
│ example:daily-task:org-123     │ Daily Task Run│ Cron     │ 0 */6 ** │ Queue      │ 2024-01-27 │ true    │ module │
│                                    │                     │          │ * *      │ currency...│ 12:00:00   │         │        │
├────────────────────────────────────┼─────────────────────┼──────────┼──────────┼────────────┼────────────┼─────────┼────────┤
...
- example:daily-task:org-123 at 2024-01-27 12:00:00 (UTC)
...
# Run by custom ID
yarn mercato scheduler run example:daily-task:org-123
```

**Output (Success):**

```
Running schedule: example:daily-task:org-123
Schedule: Daily Task Run
Type: Cron (0 */6 * * *)
Target: Queue (example-tasks)
...
✓ example:daily-task:org-123 (synced)
...
- [User Guide: Scheduled Jobs](../user-guide/scheduler)
- [Framework Reference: Scheduler Module](../framework/scheduler/overview)
- [API Reference: Scheduler API](../api/scheduler)
