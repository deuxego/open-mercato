...
- **IF** conditions are true (e.g., a field exceeds a threshold)
- **THEN** execute actions (e.g., require manager approval)

Rules can be applied to any entity type in your system and triggered by lifecycle events (beforeCreate, afterUpdate, etc.).
