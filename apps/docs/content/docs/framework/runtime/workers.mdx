...
| query_index | `fulltext-index.worker.ts` | `fulltext-indexing` | Indexes documents for fulltext search |
| query_index | `vector-index.worker.ts` | `vector-indexing` | Generates embeddings for vector queries |

## Related Documentation

- [Queue & Workers Overview](../events/queue-workers) - Queue strategies and configuration
- [Events System](../events/overview) - Event publishing and subscribers
