...
await apiCallOrThrow('/api/messages', {
  method: 'POST',
  body: JSON.stringify({
    type: 'example.task_review',
    recipients: [{ userId: 'recipient-user-uuid', type: 'to' }],
    subject: 'Task needs review',
    body: 'Please review and approve or reject this task.',
    bodyFormat: 'text',
    priority: 'high',
    objects: [
      {
...
```typescript
// packages/core/src/modules/example/message-types.ts
...
export const messageTypes: MessageTypeDefinition[] = [
  {
    type: 'example.task_review',
    module: 'example',
    labelKey: 'example.messages.taskReview',
    icon: 'check-square',
    color: 'blue',
    ui: {
...
```typescript
// packages/core/src/modules/example/message-objects.ts
import type { MessageObjectTypeDefinition } from '@open-mercato/shared/modules/messages/types'
import { ExampleMessageObjectDetail } from './widgets/messages/ExampleMessageObjectDetail'
import { ExampleMessageObjectPreview } from './widgets/messages/ExampleMessageObjectPreview'

export const messageObjectTypes: MessageObjectTypeDefinition[] = [
  {
    module: 'example',
    entityType: 'todo',
    messageTypes: ['default', 'messages.defaultWithObjects', 'example.task_review'],
    entityId: 'example:todo',
    optionLabelField: 'title',
    optionSubtitleField: 'status',
    labelKey: 'example.todos.page.title',
    icon: 'check-square',
    PreviewComponent: ExampleMessageObjectPreview,
    DetailComponent: ExampleMessageObjectDetail,
    actions: [
      {
        id: 'approve',
        labelKey: 'example.actions.approve',
        variant: 'default',
      ...
      {
        id: 'reject',
        labelKey: 'example.actions.reject',
        variant: 'destructive',
      ...
      },
      {
        ...
        variant: 'outline',
        href: '/backend/example/todos/{entityId}',
        icon: 'external-link',
        isTerminal: false,
      },
    ],
