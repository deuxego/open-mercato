...
The Integration Marketplace is your central hub for connecting Open Mercato with external services — data sync providers and more. Navigate to **External Systems → Integrations** in the sidebar.
...
Some integrations can add provider-specific tabs or tools to this page alongside the standard Credentials, Version, Health, and Logs tabs.
...
Logs are invaluable for debugging webhook deliveries and auditing credential changes.
